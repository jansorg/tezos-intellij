...
public class PsiGenericMacroImpl extends PsiMacroInstructionImpl implements PsiGenericMacro {

  public PsiGenericMacroImpl(@NotNull IElementType type) {
    super(type);
  }

  public <R> R accept(@NotNull PsiVisitor<R> visitor) {
    return visitor.visitGenericMacro(this);
  }
