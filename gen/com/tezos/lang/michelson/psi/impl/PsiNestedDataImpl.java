...
public class PsiNestedDataImpl extends PsiDataImpl implements PsiNestedData {

  public PsiNestedDataImpl(@NotNull IElementType type) {
    super(type);
  }

  public <R> R accept(@NotNull PsiVisitor<R> visitor) {
    return visitor.visitNestedData(this);
  }
