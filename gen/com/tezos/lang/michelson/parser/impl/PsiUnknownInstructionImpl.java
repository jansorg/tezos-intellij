...
public class PsiUnknownInstructionImpl extends PsiInstructionImpl implements PsiUnknownInstruction {

  public PsiUnknownInstructionImpl(@NotNull IElementType type) {
    super(type);
  }

  public <R> R accept(@NotNull PsiVisitor<R> visitor) {
    return visitor.visitUnknownInstruction(this);
  }
