...
public class PsiConditionalMacroImpl extends PsiMacroInstructionImpl implements PsiConditionalMacro {

  public PsiConditionalMacroImpl(@NotNull IElementType type) {
    super(type);
  }

  public <R> R accept(@NotNull PsiVisitor<R> visitor) {
    return visitor.visitConditionalMacro(this);
  }
