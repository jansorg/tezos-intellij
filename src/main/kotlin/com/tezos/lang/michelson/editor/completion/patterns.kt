...
val PATTERN_TAG = MichelsonTypes.TAG.toPsiPattern()
...
val PATTERN_INSTRUCTION_OR_DATA_TOKEN = TokenSet.create(MichelsonTypes.INSTRUCTION_TOKEN, MichelsonTypes.TAG_DATA).toPsiPattern()
