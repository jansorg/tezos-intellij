...
class MichelsonCompletionContributor : AbstractOriginalPosCompletionContributor() {
    init {
        ...
        // tags
        val TAG_AFTER_INSTRUCTION_TOKEN = PlatformPatterns.psiElement().withElementType(TokenSet.create(TokenType.WHITE_SPACE, TAG_TOKEN, TAG))
        ...
        val complexTag = PlatformPatterns.or(LEFT_PAREN_PATTERN, PlatformPatterns.psiElement(TAG_TOKEN).afterLeafSkipping(WHITESPACE_PATTERN, LEFT_PAREN_PATTERN))
